...
public final class CAdESUtils {
    ...
    private static Attribute getSigningCertificateV2(final X509Certificate cert,
    		                                         final String digestAlgorithmName) throws CertificateEncodingException,
        ...
        final PolicyInformation[] polInfo = getPolicyInformation(cert);
    ...
    public static ASN1EncodableVector generateSignerInfo(final Certificate cert,
        ...
        if (signingCertificateV2) {
            contextSpecific.add(
        		getSigningCertificateV2((X509Certificate) cert, digestAlgorithmName)
    		);
        }
        else {
            contextSpecific.add(
        		getSigningCertificateV1((X509Certificate) cert, digestAlgorithmName)
    		);
        }
