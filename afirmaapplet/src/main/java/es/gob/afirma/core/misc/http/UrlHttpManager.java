...
public interface UrlHttpManager {
	 ...
	 * @return Contenido de la URL
	 * @throws IOException Si no se puede leer la URL */
	byte[] readUrlByPost(String url, int timeout, String contentType, CookieManager cookieManager) throws IOException;
	 ...
	 * @return Contenido de la URL.
	 * @throws IOException Si no se puede leer la URL */
	byte[] readUrlByGet(String url, CookieManager cookieManager) throws IOException;
}
