...
public final class SignValidity {
    ...
    public enum VALIDITY_ERROR {
        ...
        UNKOWN_ERROR,
        /** Cuando los datos proporcionado no sean de ning&uacute;n tipo de firma reconocida. */
    ...
    /** Indica si el resultado corresponde a una firma v&aacute;lida
	 * @return <code>true</code> si corresponde a una firma v&aacute;lida, <code>false</code>
	 *         en caso contrario */
	public boolean isValid() {
		return this.validity == SIGN_DETAIL_TYPE.OK;
	}
