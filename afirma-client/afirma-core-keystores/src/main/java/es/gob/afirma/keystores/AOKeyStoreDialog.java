...
public final class AOKeyStoreDialog implements KeyStoreDialogManager {
	...
	public String show() throws AOCertificatesNotFoundException {
		...
		}*/ /*se comenta para que permita la seleccion de un certificado externo, 
		quizas quede mejor si se pone un boton mas grande centrado para seleccionar 
		el certificado externo*/
