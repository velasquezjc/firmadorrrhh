...
final class ConfiguratorMacOSX implements Configurator {
	...
	private static final String KS_CER_FILENAME = "/firmadigital.cer"; //$NON-NLS-1$
	private static final String KS_PASSWORD = "654321malaracha"; //$NON-NLS-1$
	private static final String CERT_CN = "127.0.0.1"; //$NON-NLS-1$
	private static final String CERT_CN_ROOT = "'Firma Digital ROOT'"; //$NON-NLS-1$
	static final String GET_USER_SCRIPT = "/getUsers.sh";//$NON-NLS-1$
	private static final String MACOSX_CERTIFICATE = "/FirmaDigital_ROOT.cer";//$NON-NLS-1$
