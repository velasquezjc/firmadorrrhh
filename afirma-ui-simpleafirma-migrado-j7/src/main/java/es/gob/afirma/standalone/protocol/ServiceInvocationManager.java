...
public final class ServiceInvocationManager {
	...
	private static int SOCKET_TIMEOUT = 60000*5; //estaba en 1 minuto, lo pase a 5
	...
	private static final String KSPASS = "654321malaracha"; //$NON-NLS-1$
	private static final String CTPASS = "654321malaracha"; //$NON-NLS-1$
	private static final String KEYSTORE_NAME = "firmadigitalkeystore.pfx"; //$NON-NLS-1$
...
//	  new Timer(delay, taskPerformer).start();
	...
	private final static Timer timer = new Timer(SOCKET_TIMEOUT, taskPerformer );
