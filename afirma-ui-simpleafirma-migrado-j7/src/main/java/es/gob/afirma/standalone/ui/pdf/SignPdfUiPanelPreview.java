...
final class SignPdfUiPanelPreview extends JPanel implements KeyListener {
	...
	private JPanel createFontPanel() {
	    ...
	    ChangeListener tarea1 = new ChangeListener() {			
			@Override
		...
		this.sizeSpinner.addChangeListener(tarea1);
		...
		this.boldButton.addActionListener(tarea2);
		...
		this.italicButton.addActionListener(tarea3);
		...
		this.underlineButton.addActionListener(tarea4);
		...
		this.strikethroughButton.addActionListener(tarea5);
	...
	private Component createTextAreaHelpPanel() {
		...
		EditorFocusManagerAction tarea3 = new EditorFocusManagerAction() {

			@Override
			public void openHyperLink(HyperlinkEvent he, int linkIndex) {
				try {
			        if (he.getURL() != null) {
	...
	private JPanel createButtonsPanel() {
		...
		this.okButton.addActionListener(tarea5);
		...
		cancelButton.addActionListener(tarea6);
	...
	public void keyPressed(final KeyEvent ke) {
		Runnable doTarea7= new Runnable() {
		     public void run() {
		...
		if (ke != null) {
			if (ke.getKeyCode() == KeyEvent.VK_ESCAPE) {
				...
				SwingUtilities.invokeLater(doTarea7);
			}
		}
	}
	...
	class RemoveImPopUpMenu extends JPopupMenu {
		...
		public RemoveImPopUpMenu(){
	        ...
	        this.removeImageItem.addActionListener(tarea10);
	...
	class AddImPopUpMenu extends JPopupMenu {
		...
		public AddImPopUpMenu(){
			final Runnable doTarea8 = new Runnable() {
			     public void run() {
			    	 getViewLabel().dispatchEvent(
					    		new MouseEvent(
					        		 SignPdfUiPanelPreview.this,
			 ...
			 ActionListener tarea9 = new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent evt) {
						SwingUtilities.invokeLater(doTarea8);
					}
				  };
	        this.addImageItem = new JMenuItem(SignPdfUiMessages.getString("SignPdfUiPreview.28")); //$NON-NLS-1$
	        this.addImageItem.addActionListener(tarea9);
