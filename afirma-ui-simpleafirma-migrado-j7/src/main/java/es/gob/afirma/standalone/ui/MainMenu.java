...
public final class MainMenu extends JMenuBar {
    ...
    private void createUI() {
        ...
        ActionListener tarea1 = new ActionListener() {
			@Override
        ...
        this.abrirMenuItem.addActionListener(tarea1);
        ...
        ActionListener tarea2 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				MainMenu.this.getSimpleAfirma().signLoadedFile();
			}
		  };
        this.firmarMenuItem.addActionListener(tarea2);
		...
		ActionListener tarea3 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				CreateHashDialog.startHashCreation(getParentComponent());
			}
		  };
		createHashFileMenuItem.addActionListener(tarea3);
		...
		checkHashFileMenuItem.setAccelerator(KeyStroke.getKeyStroke(
				KeyEvent.VK_U, Toolkit.getDefaultToolkit()
						.getMenuShortcutKeyMask()));
		ActionListener tarea4 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				CheckHashDialog.launch(getParentComponent());
			}
		  };
		checkHashFileMenuItem.addActionListener(tarea4);
		...
		createHashDirMenuItem.setAccelerator(KeyStroke.getKeyStroke(
				KeyEvent.VK_D, Toolkit.getDefaultToolkit()
						.getMenuShortcutKeyMask()));
		ActionListener tarea5 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				CreateHashFiles.startHashCreation(getParentComponent());
			}
		  };
		createHashDirMenuItem.addActionListener(tarea5);
		...
		checkHashDirMenuItem.setAccelerator(KeyStroke.getKeyStroke(
				KeyEvent.VK_K, Toolkit.getDefaultToolkit()
						.getMenuShortcutKeyMask()));
		ActionListener tarea6 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				CheckHashFiles.startHashCheck(getParentComponent());
			}
		  };
		checkHashDirMenuItem.addActionListener(tarea6);
        ...
        if (!isMac) {
			...
			ActionListener tarea7 = new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent evt) {
					exitApplication();
				}
			  };
			salirMenuItem.addActionListener(tarea7);
        ...
        if (!isMac) {
            ...
            ActionListener tarea8 = new ActionListener() {
    			@Override
    			public void actionPerformed(ActionEvent evt) {
    				showPreferences();
    			}
    		  };
            preferencesMenuItem.addActionListener(tarea8);
        ...
        // En Mac OS X el menu es "Preferencias" dentro de la opcion principal
        	...
        	PreferencesHandler tarea9 = new PreferencesHandler() {
				@Override
        	...
        	try {
        		com.apple.eawt.Application.getApplication().setPreferencesHandler(tarea9);
        	}
        ...
        ActionListener tarea10 = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				SimpleAfirma.showHelp();
			}
		  };
        ayudaMenuItem.addActionListener(tarea10);
        ...
        // Acciones especificas de Mac OS X
        	...
        	try {
        		AboutHandler tarea12 = new AboutHandler() {
        		...
        		com.apple.eawt.Application.getApplication().setAboutHandler(tarea12);
        		
        		QuitHandler tarea13 = new QuitHandler() {
	            ...
	            com.apple.eawt.Application.getApplication().setQuitHandler(tarea13);
        	}
        	catch(final Exception | Error e) {
        		Logger.getLogger("es.gob.afirma").warning( //$NON-NLS-1$
