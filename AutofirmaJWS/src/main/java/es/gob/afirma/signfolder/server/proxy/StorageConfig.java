...
public class StorageConfig {
	...
	private static String DEFAULT_TMP_DIR = "temp";
	...
	private static final long DEFAULT_EXPIRATION_TIME = 90000; // 5 segundos
	...
	public void load(final String path) throws FileNotFoundException, IOException {
		if (path != null) {
			this.config.setProperty(TMP_DIR_KEY, DEFAULT_TMP_DIR);
			this.config.setProperty(EXPIRATION_TIME_KEY, String.valueOf(DEFAULT_EXPIRATION_TIME));
 		/*	
			try {
